...
func LoadConf() {
	...
	// 读取Vercel配置
	Conf.Server = "http://localhost:5897"
	Conf.StaticServer = ""
	Conf.StaticResourceVersion = "1653372433379"
	Conf.RuntimeMode = "dev"
	Conf.LogLevel = "debug"
	Conf.ShowSQL, _ = strconv.ParseBool(os.Getenv("CONF_SHOW_SQL"))
	Conf.SessionSecret = ""
	Conf.SessionMaxAge = 86400
	Conf.SQLite = os.Getenv("CONF_SQLITE")
	Conf.MySQL = os.Getenv("CONF_MYSQL")
	Conf.Postgres = os.Getenv("CONF_POSTGRES")
	Conf.Port = "5897"
	Conf.AxiosBaseURL = "/api"
	Conf.MockServer = "http://localhost:8888"
